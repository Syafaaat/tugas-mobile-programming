...
public class FragmentHarga extends Fragment {
     ...
     * @return A new instance of fragment FragmentHarga.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentHarga newInstance(String param1, String param2) {
        FragmentHarga fragment = new FragmentHarga();
    ...
    private void getAllData() {
        ...
        call.enqueue(new Callback<ListProdukModel>() {
            ...
            public void onResponse(Call<ListProdukModel> call, Response<ListProdukModel> response) {
                ...
                CustomAdapter customAdapter = new CustomAdapter(mListProduk, getActivity());
    ...
    public class CustomAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            EditText hargaProduk = view.findViewById(R.id.harga_barang);
            Button btn_simpan_harga = view.findViewById(R.id.btn_simpan_harga);
            Button btn_hapus_harga = view.findViewById(R.id.btn_hapus_harga);
            ...
            btn_simpan_harga.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    String id = String.valueOf(produkModel.get(i).getId());
                    String hargaUpdate = hargaProduk.getText().toString().trim();

                    if (TextUtils.isEmpty(hargaUpdate)){
                        hargaProduk.setError("Data tidak boleh kosong!");
                    }else{
                        ApiService apiService = ApiClient.getRetrofit().create(ApiService.class);
                        Call<ListProdukModel> call = apiService.updateHarga(
                                id,
                                hargaUpdate
                        );
                        call.enqueue(new Callback<ListProdukModel>() {
            ...
            btn_hapus_harga.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ApiService apiService = ApiClient.getRetrofit().create(ApiService.class);
                    Call<ListProdukModel> call = apiService.deleteProduk(produkModel.get(i).getId());
                    call.enqueue(new Callback<ListProdukModel>() {
                        @Override
                        public void onResponse(Call<ListProdukModel> call, Response<ListProdukModel> response) {
                            Toast.makeText(getContext(), "Berhasil", Toast.LENGTH_SHORT).show();
