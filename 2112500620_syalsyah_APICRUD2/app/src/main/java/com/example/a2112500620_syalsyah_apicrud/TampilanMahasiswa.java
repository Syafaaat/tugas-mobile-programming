...
public class TampilanMahasiswa extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampilan_mahasiswa);
    ...
    private void getMahasiswa(){
        class GetMahasiswa extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute(){
                super.onPreExecute();
                loading = ProgressDialog.show(TampilanMahasiswa.this, "Fetching...","wait...", false, false);
            }
            @Override
    ...
    private void updateMahasiswa(){
        ...
        class UpdateMahasiswa extends AsyncTask<Void, Void, String>{
            ...
            protected void onPreExecute(){
                super.onPreExecute();
                loading = ProgressDialog.show(TampilanMahasiswa.this, "Updating...", "Wait...", false, false);
            }
            protected void onPostExecute(String s){
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(TampilanMahasiswa.this,s,Toast.LENGTH_LONG).show();
                startActivity(new Intent(TampilanMahasiswa.this, TampilSemuaMahasiswa.class));
            }
            protected String doInBackground(Void... params) {
    ...
    private void deleteMahasiswa(){
        class deleteMahasiswa extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute(){
                super.onPreExecute();
                loading = ProgressDialog.show(TampilanMahasiswa.this, "Delete...", "wait...", false, false);
            }
            @Override
            protected void onPostExecute(String s){
                super.onPostExecute(s);
