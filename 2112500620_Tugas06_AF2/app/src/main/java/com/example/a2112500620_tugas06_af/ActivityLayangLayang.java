...
public class ActivityLayangLayang extends AppCompatActivity {
        ...
        hitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(valdiagonal1)) {
                    ...
                    double luaslayang = 0.5 * diagonal1 * diagonal2;

                    String hasillayang = "Luas layang layang: " + String.valueOf(luaslayang) + " cm";
                    Hasil.setText(hasillayang);
                }
            }
        });
    }
